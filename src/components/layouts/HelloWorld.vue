...
const question = ref('');
const myTastes = ref('');
const lyricsOrNot = ref('');

const moodOptions = [
  { text: 'Happy', value: 'happy' },
  { text: 'Sad', value: 'sad' },
  { text: 'Irritated', value: 'irritated' },
...
.mood-option input[type="radio"]:checked + circle {
  background-color: #000;
}

/** css for favourite question **/
.favourite-song {
  margin-top: 20px;
}

/** css for yes/no question **/
.me {
  margin-top: 20px;
}
.me label {
